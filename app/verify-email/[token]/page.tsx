  ...
  return (
    <main className="grid min-h-dvh place-items-center bg-[#faf7f4] p-4">
      <section className="w-full max-w-md rounded-[2rem] bg-white p-6 text-center soft-card">
        ...
        <p className="mt-3 text-sm text-black/60">{verified ? "Your account is ready to use." : "Request a fresh verification email by signing up again or contacting support."}</p>
