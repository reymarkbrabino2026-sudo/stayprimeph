    ...
    >
      <div className="grid gap-4 lg:grid-cols-2">
        {settings.map(([name, ready, description]) => (
          <article key={name} className="min-w-0 rounded-[1.5rem] bg-white p-5 soft-card">
            <div className="flex flex-col gap-4 min-[420px]:flex-row min-[420px]:items-start min-[420px]:justify-between">
              ...
              <span className={`w-fit rounded-full px-3 py-1 text-xs font-semibold ${ready ? "bg-emerald-100 text-emerald-700" : "bg-amber-100 text-amber-700"}`}>
