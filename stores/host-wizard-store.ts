...
export function sanitizeHostWizardDraftForStorage(draft: HostListingDraft): Partial<HostListingDraft> {
  return {
    ...
    locationPinned: draft.locationPinned,
    locationConfirmed: draft.locationConfirmed,
    locationConfirmedAddress: draft.locationConfirmedAddress,
    lastAutoGeocodeAddress: draft.lastAutoGeocodeAddress,
    propertyType: draft.propertyType,
    privacyType: draft.privacyType,
    preciseLocation: draft.preciseLocation,
    guests: draft.guests,
    ...
    hostAsBusiness: draft.hostAsBusiness,
    status: draft.status,
