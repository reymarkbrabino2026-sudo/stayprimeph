...
export const amenityGroups: AmenityGroup[] = [
  { id: "favorites", title: "Guest favorites", items: [["wifi", "WiFi", "wifi"], ["tv", "TV", "tv"], ["smart-tv-netflix", "Smart TV (with Netflix)", "tv"], ["kitchen", "Kitchen", "cooking-pot"], ["washer", "Washer", "washing-machine"], ["parking", "Free parking", "car-front"], ["workspace", "Workspace", "laptop"], ["aircon", "Fully airconditioned", "snowflake"]].map(([id, label, icon]) => ({ id, label, icon })) },
  { id: "rooms-comfort", title: "Rooms & comfort facilities", items: [["sunken-lounge", "Sunken lounge", "sofa"], ["indoor-dining", "Indoor dining", "utensils-crossed"], ["hot-cold-shower", "Hot & cold shower", "bath"], ["patio-dining", "Patio dining", "umbrella"], ["outdoor-toilet", "Outdoor toilet", "door-open"], ["outdoor-shower", "Outdoor shower", "waves"]].map(([id, label, icon]) => ({ id, label, icon })) },
  { id: "ground-floor-entertainment", title: "Ground floor - Entertainment & leisure", items: [["pool", "Heated pool (3ft-5ft)", "waves"], ["massage-chair", "Massage chair (bills operated)", "armchair"], ["smart-tv-netflix", "Smart TV (with Netflix)", "tv"], ["karaoke", "Karaoke", "mic"], ["board-games", "Board games", "puzzle"], ["card-games", "Card games", "layers"], ["sauna", "Sauna (free 1 hr of use - max 2 inside)", "flame"], ["projector", "Projector setup at night (by request)", "projector"], ["dartboard", "Dartboard", "target"], ["wifi", "WiFi", "wifi"]].map(([id, label, icon]) => ({ id, label, icon })) },
  { id: "ground-floor-kitchen-dining", title: "Ground floor - Kitchen & dining", items: [["indoor-kitchen", "Indoor kitchen - airconditioned", "cooking-pot"], ["electric-stove", "Electric stove", "flame"], ["refrigerator", "Refrigerator", "snowflake"], ["microwave", "Microwave oven", "cooking-pot"], ["outdoor-kitchen", "Outdoor kitchen", "utensils-crossed"], ["gas-stove", "Gas stove", "flame"], ["rice-cooker", "Rice cooker", "cooking-pot"], ["grilling-station", "Grilling station", "flame"], ["cooking-ware", "Cooking ware", "cooking-pot"], ["plates-utensils-serving", "Plates, utensils & serving trays", "utensils-crossed"]].map(([id, label, icon]) => ({ id, label, icon })) },
  { id: "outdoor", title: "Outdoor amenities", items: [["hot-tub", "Hot tub", "bath"], ["patio", "Patio", "umbrella"], ["bbq", "BBQ grill", "flame"], ["outdoor-dining", "Outdoor dining", "utensils-crossed"], ["fire-pit", "Fire pit", "bonfire"]].map(([id, label, icon]) => ({ id, label, icon })) },
  { id: "security-convenience", title: "Security & convenience", items: [["cctv-monitored", "CCTV monitored", "shield-alert"], ["solar-powered", "Solar powered", "sun"], ["large-parking", "Parking space", "car-front"]].map(([id, label, icon]) => ({ id, label, icon })) },
