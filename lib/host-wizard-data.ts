...
export const amenityGroups: AmenityGroup[] = [
  ...
  { id: "standout", title: "Entertainment & leisure", items: [["pool", "Heated pool", "waves"], ["sauna", "Sauna", "flame"], ["massage-chair", "Massage chair", "armchair"], ["projector", "Projector setup", "projector"], ["karaoke", "Karaoke", "mic"], ["dartboard", "Dartboard", "target"], ["board-games", "Board games", "puzzle"], ["card-games", "Card games", "layers"]].map(([id, label, icon]) => ({ id, label, icon })) },
  { id: "kitchen-dining", title: "Kitchen & dining", items: [["indoor-kitchen", "Indoor kitchen", "cooking-pot"], ["outdoor-kitchen", "Outdoor kitchen", "utensils-crossed"], ["electric-stove", "Electric stove", "flame"], ["gas-stove", "Gas stove", "flame"], ["refrigerator", "Refrigerator", "snowflake"], ["microwave", "Microwave oven", "cooking-pot"], ["rice-cooker", "Rice cooker", "cooking-pot"], ["grilling-station", "Grilling station", "flame"], ["cooking-ware", "Cooking ware", "cooking-pot"], ["plates-utensils-serving", "Plates, utensils & serving trays", "utensils-crossed"]].map(([id, label, icon]) => ({ id, label, icon })) },
