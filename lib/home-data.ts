...
export const homeRails: { title: string; items: HomeRailItem[] }[] = [
  {
    ...
    items: [
      ["Condo in Baguio", "PHP 13,010 for 2 nights", "4.88", "Superhost", 164],
      ["Home in Baguio", "PHP 6,830 for 2 nights", "4.95", "Guest favorite", 175],
      ["Tiny home in Baguio", "PHP 3,893 for 2 nights", "4.92", "Guest favorite", 188],
      ["Condo in Baguio", "PHP 8,125 for 2 nights", "4.93", "Guest favorite", 201],
      ["Place to stay in Baguio", "PHP 3,081 for 2 nights", "5.0", "Guest favorite", 219],
      ["Apartment in Baguio", "PHP 10,267 for 2 nights", "5.0", "Guest favorite", 227],
      ["Apartment in Baguio", "PHP 8,911 for 2 nights", "4.79", "Guest favorite", 238],
    ],
  },
  {
    title: "Stay in Barangay 76",
    items: [
      ["Apartment in Pasay", "PHP 9,100 for 2 nights", "4.91", "Guest favorite", 250],
      ["Loft in Pasay", "PHP 8,440 for 2 nights", "4.96", "Superhost", 255],
      ["Condo in Pasay", "PHP 7,520 for 2 nights", "4.89", "Guest favorite", 264],
      ["Studio in Pasay", "PHP 6,230 for 2 nights", "4.93", "Guest favorite", 274],
      ["Home in Pasay", "PHP 10,400 for 2 nights", "5.0", "Superhost", 286],
      ["Apartment in Pasay", "PHP 7,690 for 2 nights", "4.86", "Guest favorite", 292],
      ["Condo in Pasay", "PHP 8,220 for 2 nights", "4.82", "Guest favorite", 299],
    ],
  },
];
...
export const experienceRail: { title: string; items: HomeRailItem[] } = {
  ...
  items: [
    ["Makati Street Food Experience End in a Rooftop Bar", "From PHP 3,500 / guest", "4.91", "Popular", 331],
    ["Discover the Real Manila with Tuktuk and Jeepney", "From PHP 3,500 / guest", "4.95", "Popular", 342],
    ["Explore Intramuros with Local Guide", "From PHP 3,000 / guest", "4.93", "Popular", 350],
    ["Street food tasting tour in Mandaluyong", "From PHP 3,591 / guest", "4.93", "Popular", 363],
    ["Makati: Rooftop, Clubs, Live Music & Street Food", "From PHP 999 / guest", "5.0", "Popular", 377],
    ["Intramuros: Heritage and Food Guided Tour", "From PHP 1,360 / guest", "5.0", "Popular", 390],
    ["Manila Social and Political Walk", "From PHP 2,380 / guest", "4.79", "Popular", 399],
  ],
};
